...
// @updateURL    https://raw.githubusercontent.com/brianlin-19780816/ADO-Test-state-monitoring-R-SCM-Qual/main/C4142-R-SCM-Dashboard.user.js
// @downloadURL  https://raw.githubusercontent.com/brianlin-19780816/ADO-Test-state-monitoring-R-SCM-Qual/main/C4142-R-SCM-Dashboard.user.js
...
(function () {
  ...
  var D = {};
  D.CFG = {"org":"https://azurecsi.visualstudio.com","orgName":"azurecsi","project":"Dev","sourceType":"testPlan","planId":4017580,"suiteId":4017581,"queryId":"","queryUrl":"https://azurecsi.visualstudio.com/Dev/_testPlans/charts?planId=4017580&suiteId=4017581","testResultDays":28};
  if (extensionContext) {
    ...
    D.CFG.queryUrl = D.CFG.orgName === 'azurecsi' && D.CFG.project === 'Dev'
      ? 'https://azurecsi.visualstudio.com/Dev/_testPlans/charts?planId=4017580&suiteId=4017581'
      : D.CFG.org + '/' + encodeURIComponent(D.CFG.project) + '/_queries/query/' + D.CFG.queryId + '/';
  }
  D.DEFAULT_QUERIES = [
    { name: 'R-SCM Qual', org: 'https://azurecsi.visualstudio.com', orgName: 'azurecsi', project: 'Dev', sourceType: 'testPlan', planId: 4017580, suiteId: 4017581, queryId: '', queryUrl: 'https://azurecsi.visualstudio.com/Dev/_testPlans/charts?planId=4017580&suiteId=4017581', builtin: true },
